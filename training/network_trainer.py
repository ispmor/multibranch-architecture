...
class NetworkTrainer:
    ...
    def train_network(self, model, training_data_loader, epoch, include_domain=True, parameters_to_prune=()):
        ...
        model.modelA.lstm_alpha1 = prune.random_unstructured(module=model.modelA.lstm_alpha1, name= 'weight_ih_l0', amount=0.05)
        model.modelA.lstm_alpha1 = prune.random_unstructured(module=model.modelA.lstm_alpha1, name= 'weight_ih_l1', amount=0.05)
        model.modelA.lstm_alpha1 = prune.random_unstructured(module=model.modelA.lstm_alpha1, name= 'weight_hh_l0', amount=0.05)
        model.modelA.lstm_alpha1 = prune.random_unstructured(module=model.modelA.lstm_alpha1, name= 'weight_hh_l1', amount=0.05)
        model.modelA.fc = prune.random_unstructured(module=model.modelA.fc, name='weight', amount=0.05)
        model.modelB.lstm_alpha1 = prune.random_unstructured(module=model.modelB.lstm_alpha1, name= 'weight_ih_l0', amount=0.05)
        model.modelB.lstm_alpha1 = prune.random_unstructured(module=model.modelB.lstm_alpha1, name= 'weight_ih_l1', amount=0.05)
        model.modelB.lstm_alpha1 = prune.random_unstructured(module=model.modelB.lstm_alpha1, name= 'weight_hh_l0', amount=0.05)
        model.modelB.lstm_alpha1 = prune.random_unstructured(module=model.modelB.lstm_alpha1, name= 'weight_hh_l1', amount=0.05)
        model.modelB.fc = prune.random_unstructured(module=model.modelB.fc, name='weight', amount=0.05)
        model.modelC.lstm_alpha1 = prune.random_unstructured(module=model.modelC.lstm_alpha1, name= 'weight_ih_l0', amount=0.05)
        model.modelC.lstm_alpha1 = prune.random_unstructured(module=model.modelC.lstm_alpha1, name= 'weight_ih_l1', amount=0.05)
        model.modelC.lstm_alpha1 = prune.random_unstructured(module=model.modelC.lstm_alpha1, name= 'weight_hh_l0', amount=0.05)
        model.modelC.lstm_alpha1 = prune.random_unstructured(module=model.modelC.lstm_alpha1, name= 'weight_hh_l1', amount=0.05)
        model.modelC.fc = prune.random_unstructured(module=model.modelC.fc, name='weight', amount=0.05)
        model.modelD.lstm_alpha1 = prune.random_unstructured(module=model.modelD.lstm_alpha1, name= 'weight_ih_l0', amount=0.05)
        model.modelD.lstm_alpha1 = prune.random_unstructured(module=model.modelD.lstm_alpha1, name= 'weight_ih_l1', amount=0.05)
        model.modelD.lstm_alpha1 = prune.random_unstructured(module=model.modelD.lstm_alpha1, name= 'weight_hh_l0', amount=0.05)
        model.modelD.lstm_alpha1 = prune.random_unstructured(module=model.modelD.lstm_alpha1, name= 'weight_hh_l1', amount=0.05)
        model.modelD.fc = prune.random_unstructured(module=model.modelD.fc, name='weight', amount=0.05)
        model.modelE.lstm_alpha1 = prune.random_unstructured(module=model.modelE.lstm_alpha1, name= 'weight_ih_l0', amount=0.05)
        model.modelE.lstm_alpha1 = prune.random_unstructured(module=model.modelE.lstm_alpha1, name= 'weight_ih_l1', amount=0.05)
        model.modelE.lstm_alpha1 = prune.random_unstructured(module=model.modelE.lstm_alpha1, name= 'weight_hh_l0', amount=0.05)
        model.modelE.lstm_alpha1 = prune.random_unstructured(module=model.modelE.lstm_alpha1, name= 'weight_hh_l1', amount=0.05)
        model.modelE.fc = prune.random_unstructured(module=model.modelE.fc, name='weight', amount=0.05)
        model.modelF.lstm_alpha1 = prune.random_unstructured(module=model.modelF.lstm_alpha1, name= 'weight_ih_l0', amount=0.05)
        model.modelF.lstm_alpha1 = prune.random_unstructured(module=model.modelF.lstm_alpha1, name= 'weight_ih_l1', amount=0.05)
        model.modelF.lstm_alpha1 = prune.random_unstructured(module=model.modelF.lstm_alpha1, name= 'weight_hh_l0', amount=0.05)
        model.modelF.lstm_alpha1 = prune.random_unstructured(module=model.modelF.lstm_alpha1, name= 'weight_hh_l1', amount=0.05)
        model.modelF.fc = prune.random_unstructured(module=model.modelF.fc, name='weight', amount=0.05)
