...
class NetworkTrainer:
    ...
    def train(self, blendModel, training_data_loader, validation_data_loader, fold, leads):
        best_model_name=""
        epochs_no_improve=0
        min_val_loss=999999
        for epoch in range(self.training_config.num_epochs):
            ...
            if epoch_validation_loss < min_val_loss:
                ...
                model_name = f"models_repository/{self.alpha_config.network_name}_{self.beta_config.network_name}_{leads}_{time.time()}.th"
