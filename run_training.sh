...
FLAGS="--network ${NETWORK} --epochs 30 --early-stop 5 --alpha-hidden ${ALPHA_HIDDEN} --alpha-layers ${ALPHA_LAYERS} --alpha-input-size 1500 --beta-input-size 759 --gamma-input-size 256 --delta-input-size 10668 --epsilon-input-size 1500 --zeta-input-size 1500 --window-size 1500 --wavelet-features-size 759 -d"
